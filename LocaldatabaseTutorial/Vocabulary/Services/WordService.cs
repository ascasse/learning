...
{
    public class WordService : IVocabularyData<Category>
    {
        ...
        public WordService()
        {
            Database = new DBWords(Constants.DatabasePath);
        }

        public WordService(string connectionString)
        {
        ...
        public async Task<int> AddItemAsync(Category newCategory)
        {
            return await Database.CreateCategory(newCategory);
        }

        public async Task<Category> UpdateItemAsync(Category category)
        {
        ...
        public async Task<int> DeleteItemAsync(int categoryId)
        {
            return await Database.DeleteCategory(categoryId);
        }

        public async Task<IEnumerable<Category>> GetRecentAsync(bool forceRefresh)
        {
        ...
        {
            var category = await GetItemAsync(category_id);
